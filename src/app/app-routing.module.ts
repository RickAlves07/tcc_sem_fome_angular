...
const routes: Routes = [
	...
	{ path: 'donations/transfer/new', component: NewDonationComponent, canActivate: [AuthenticationService] },
	...
	{ path: 'donations/transfer/in-progress', component: DonationsInProgressComponent, canActivate: [AuthenticationService] },
